                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  {{-- Familyname of the user--}}
                    <div class="form-group col-md-6 mb-50">
                      ...
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="familyname" value="{{ old('familyname') }}" required autocomplete="name" autofocus placeholder="Nom de famille">
                      @error('familyname')
                    ...
                    <div class="form-group col-md-6 mb-50">
                      ...
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="givenname" value="{{ old('givenname') }}" required autocomplete="name" autofocus placeholder="Prenoms">
                      @error('givenname')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-50">
                      ...
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="familyname" value="{{ old('familyname') }}" required autocomplete="name" autofocus placeholder="First name">
                      @error('familyname')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group col-md-6 mb-50">
                      ...
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="givenname" value="{{ old('givenname') }}" required autocomplete="name" autofocus placeholder="Last name">
                      @error('givenname')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
