              ...
              <div class="card">
                  <div class="flip">
                      <div class="front">
                          ...
                          <div class="investor">Myschool</div>
                          <div class="chip">
                          ...
                          <div class="card-number">
                              <div class="section">7954</div>
                              <div class="section">9937</div> |
                              <div class="section">7592</div>
                              <div class="section">7364</div>
                          </div>
                          <div class="end"><span class="end-text">Contactez</span><span class="end-date"> nous</span></div>
                          <div class="card-holder">Pour votre paiement</div>
                          <div class="master">
                      ...
                      <div class="back">
                          ...
                          <div class="terms">
                              <p>Cette application est une propriété de yioxsystem tout droit reservés.</p>
                              <p>Copyright 2020 - 2021 tous droits reservés.</p>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="card">
                  <div class="flip">
                      <div class="front">
                          ...
                          <div class="end"><span class="end-text">Contact us</span><span class="end-date"> nous</span></div>
                          <div class="card-holder">For you Billing</div>
                          <div class="master">
                              <div class="circle master-red"></div>
                              <div class="circle master-yellow"></div>
                          </div>
                      ...
                      <div class="back">
                          ...
                          <div class="terms">
                              <p>This software is a property of YIOXSYSTEM.</p>
