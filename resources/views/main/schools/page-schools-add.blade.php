        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form class="form" method="POST" id="school_add" action="{{route('schools-add')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control required" id="schoolname" name="schoolname"
                            placeholder="Nom de l'école"  maximum="256" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control required maskField" id="schoolphone"  mask="999-999-999-999-999" maxlength="19" name="phone"
                            placeholder="Téléphone de l'école" maximum="256" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control required" id="schooltown" name="area"
                            placeholder="Ville" maximum="256" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control required" id="schooladdress" name="address"
                            placeholder="Adresse de l'école ex: area - city..."  maximum="256" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="schoolnbroom">Nombre de salle</label>
                            <input type="number" class="form-control required" id="schoolnbroom" name="nbroom"
                            placeholder="Nombre de salle" maximum="256" required>
                      ...
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            placeholder="Nom du fondateur" maximum="256" required>
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control required" id="schoolname" name="schoolname"
                        placeholder="The name of the school" maximum="256" required>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control required maskField" id="schoolphone"  mask="999-999-999-999-999" maxlength="19" name="phone"
                        placeholder="Phone of the school" maximum="256" required>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control required" id="schooltown" name="area"
                        placeholder="Town of the country" maximum="256" required>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control required" id="schooladdress" name="address"
                        placeholder="Address of the school eg: area - city..." maximum="256" required>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control required" id="schoolnbroom" name="nbroom"
                        placeholder="Number of room into the school" maximum="256" required>
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control required" id="schoolfunder" name="funder"
                        placeholder="Funder's Name of the school" maximum="256" required>
                    </div>
                  </div>
                  <div class="col-md-6 col-12">
                    <div class="form-group">
