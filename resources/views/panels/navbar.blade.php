            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon bx bx-search"></i></a>
                <div class="search-input">
                  ...
                  <input class="input" type="text" placeholder="Explore mySchool..." tabindex="-1" data-search="template-search">
              ...
              <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                  ...
                  <span><img class="round" src="@if($user->photo == NULL && $user->gender == false) {{asset('images/mockup/man.jpg')}} @elseif($user->photo == NULL && $user->gender == true) {{asset('images/mockup/woman.jpg')}} @else {{asset($user->photo)}} @endif" alt="avatar" height="40" width="40"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a class="dropdown-item" href="{{asset('app-email')}}">
                    <i class="bx bx-envelope mr-50"></i> Messagerie
                  </a>
                  <div class="dropdown-divider mb-0"></div>
                  <a class="dropdown-item" href="{{route('auth-logout')}}"><i class="bx bx-power-off mr-50"></i> Déconnexion</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="{{asset('app-email')}}">
                <i class="bx bx-envelope mr-50"></i> Chat
              </a>
              <div class="dropdown-divider mb-0"></div>
